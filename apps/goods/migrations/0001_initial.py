# Generated by Django 2.2.2 on 2019-12-05 06:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_sum', models.IntegerField(default=0, verbose_name='库存数')),
                ('market_price', models.DecimalField(decimal_places=2, default=0.0, max_digits=11, verbose_name='市场价格')),
                ('shop_price', models.DecimalField(decimal_places=2, default=0.0, max_digits=11, verbose_name='本店价格')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.IntegerField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], help_text='类目级别', verbose_name='类目类别')),

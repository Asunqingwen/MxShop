...
class GoodsCategory(BaseModel):
	...
	# 目录树级别
	category_type = models.IntegerField("类目类别", choices=CATEGORY_TYPE, help_text="类目级别")
	# 设置models有一个指向自己的外键
...
class Goods(BaseModel):
	...
	goods_sum = models.IntegerField("库存数", default=0)
	market_price = models.DecimalField("市场价格", max_digits=11, decimal_places=2, default=0.00)
	shop_price = models.DecimalField("本店价格", max_digits=11, decimal_places=2, default=0.00)
